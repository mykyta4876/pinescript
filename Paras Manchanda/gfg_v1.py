...
def update_google_sheet(dataframe, credentials_filename, sheet_name, ticker, signal, number):
	...
	try:
		...
		print(f"[-] update_google_sheet {signal}: update Google Sheet successfully.")
	except gspread.exceptions.APIError:
		print(f"[-] update_google_sheet {signal}: error: gspread.exceptions.APIError")
