...
class Engine9:
    ...
    def process_data(self):
        ...
        try:
            ...
            output_file = f"{input_name}_{self.timeframe}{self.option_type}{self.multiplier}_e9.xlsx"
...
def main():
    if len(sys.argv) != 5:
        logger.error("Usage: python engine9.py <timeframe> <option_type> <multiplier> <input_file>")
        logger.error("Example: python engine9.py 1m C 2 'SPY_Weekly.xlsx'")
        return
    ...
    try:
        ...
        engine = Engine9(timeframe, option_type, multiplier, input_file)
        engine.process_data()
