...
python "HA Losing Arrows MD1R.py" -f "BATS_QQQ, 5.csv" -sd 20240301 -m 0.5 -r 14
...
def parse_arguments():
    ...
    parser.add_argument("--restriction_len", "-r", help="restriction length", type=int)
...
output_df = df[['time', 'open', 'high', 'low', 'close', 'Volume', 'count', 'avg', 'upArrow2', 'dnArrow2', 'upArrow2r', 'dnArrow2r']]
...
output_filename = output_filename + ",MD1R,-m " +  str(Multiplier) + ".csv"
